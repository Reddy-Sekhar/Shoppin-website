...
const LeadDetailsModal = ({ lead, onClose, onStatusChange }) => {
    ...
    const productType = lead.productType ?? lead.product_type ?? '';
    const referenceImages = lead.referenceImages ?? lead.reference_images ?? [];
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden relative animate-in fade-in zoom-in flex flex-col max-h-[90vh]">
                ...
                <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-white sticky top-0 z-10">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">ID: {leadId}</p>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium text-gray-900">{createdAt ? new Date(createdAt).toLocaleDateString() : '—'}</p>
                                    <p className="text-xs text-gray-500">{createdAt ? new Date(createdAt).toLocaleTimeString() : ''}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                ...
                                <p className="font-bold text-gray-900">{lead.quantity || 0} pcs</p>
                            </div>
                            <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                <div className="flex items-center gap-2 mb-2 text-gray-500">
                ...
                <div className="p-6 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
                    <button
                        onClick={() => window.location.href = `/seller/costing?leadId=${leadId}`}
