...
import {
    ...
    Settings, LogOut, Package, ClipboardCheck, Palette, File,
    UserCircle
} from 'lucide-react';
...
const DashboardLayout = () => {
    ...
    if (user?.role === 'BUYER') {
        ...
        menuItems = [
            ...
            { name: 'Profile', path: '/designer/profile', icon: UserCircle },
        ];
            ...
            <div className="flex h-screen pt-20">
                ...
                <aside className="w-64 bg-white shadow-md flex flex-col h-full">
                    <div className="p-6 border-b">
                        ...
                        <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider">{(user?.roleLabel || user?.role || '').toString()}</p>
                    </div>
