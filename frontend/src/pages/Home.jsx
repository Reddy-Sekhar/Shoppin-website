      ...
      <div className="container-custom relative z-10 w-full pt-20 pb-20">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold mb-6 leading-tight">
            <span className="text-white">Premium Apparel</span> <br className="hidden md:block" />
      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {[
            {
              title: 'Resort Wear',
              image: 'https://images.unsplash.com/photo-1763558966748-f56b4d0fb104?auto=format&fit=crop&w=1400&q=85',
            },
            {
              title: 'Modest Fashion',
              image: 'https://images.unsplash.com/photo-1668028563825-f3b7138db3de?auto=format&fit=crop&w=1400&q=85',
            },
            {
              title: 'Luxury Kaftans',
              image: 'https://images.unsplash.com/photo-1566206091558-7f218b696731?q=80&auto=format&fit=crop&w=1000',
            },
          ].map((item, idx) => (
            <div
              key={idx}
